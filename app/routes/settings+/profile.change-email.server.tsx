...
export async function handleVerification({
	...
	// Get the user before updating the email so we can notify them
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>{`${appName} Email Change`}</E.Text>
				</h1>
				<p>
					<E.Text>
...
function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>{`Your ${appName} email has been changed`}</E.Text>
				</h1>
				<p>
					<E.Text>
						{`We're writing to let you know that your ${appName} email has been changed.`}
					</E.Text>
				</p>
				<p>
					<E.Text>
